<div class="bg-white py-6 md:py-20 dark:bg-gray-800">
  <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
    <div class="bg-gray-100 rounded-lg px-4 py-6 md:py-8 lg:py-12 dark:bg-gray-900">
      ...
      <p class="max-w-screen-md text-gray-500 md:text-lg text-center mx-auto dark:text-white">This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random or otherwise generated.</p>
    </div>
  </div>
</div>